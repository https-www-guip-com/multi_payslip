...
class MultiEmployeeWiz(models.TransientModel):
    ...
    month_from = fields.Selection(MONTHS, 'Fecha Inicial', required=True)
    month_to = fields.Selection(MONTHS, 'Fecha Final', required=True)
    active = fields.Boolean("Empleados Activos")
